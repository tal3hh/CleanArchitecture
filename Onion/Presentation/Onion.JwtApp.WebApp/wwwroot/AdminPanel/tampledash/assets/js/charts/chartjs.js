$(function () {
    ...
    if ($("#chartjs-bar-chart").length) {
        var BarData = {
            labels: ["IT Web", "HR", "RM", "IM", "ACC", "LP"],
            datasets: [{
                label: '# of Votes',
                data: [@Model[0].MemberCount,@Model[1].MemberCount,@Model[2].MemberCount,@Model[3].MemberCount,@Model[4].MemberCount,@Model[5].MemberCount],
